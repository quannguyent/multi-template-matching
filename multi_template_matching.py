...
pick = non_max_suppression_fast(np.array(rects))
...
for (startX, startY, endX, endY) in pick:
	...
	cv2.putText(image, str(count), (startX, startY-5), cv2.FONT_HERSHEY_SIMPLEX, 1, (0,0,0), 2)
	
# show the output image
cv2.imshow("After NMS", image)
# cv2.imwrite('C:/Users/Quan/Desktop/count_template.jpg', template)
# cv2.imwrite('C:/Users/Quan/Desktop/count.jpg', image)
# cv2.imwrite('C:/Users/Quan/Desktop/find_template.jpg', template)
# cv2.imwrite('C:/Users/Quan/Desktop/find.jpg', image)
cv2.waitKey(0)